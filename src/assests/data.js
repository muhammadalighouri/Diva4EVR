...
export const team = [
  {
    name: "ToneQ",
    position:
      "Founder & Artist who loves to create multi-universes with his art skills.",
    path: "/images/team/darkotoid.2.png",
    link: "twitter.com/shoto_j",
  },
  {
    name: "James O",
    position:
      " Project Advisor, Founder of Paycheck.io, Entrepreneur, Crypto Analyst, Artist & Designer.",
    path: "/images/team/advisor.jpg",
    link: "twitter.com/shoto_j",
  },
  {
    name: " ALI  ",
    position: " He does the Dev work and other stuff  ",
    path: "/images/team/21.png",
    link: "",
  },
  {
    name: "Dream    ",
    position: "Handles some of the art but is the master of community vibes.",
    path: "/images/team/Phantrax.png",
    link: "twitter.com/shoto_j",
  },
];
